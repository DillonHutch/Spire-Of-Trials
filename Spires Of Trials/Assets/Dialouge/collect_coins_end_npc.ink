...
~ FinishQuest(CollectCoinsQuestId)
    ...
    OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
        ...
        OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOINS 
    
    Thank you brave adventurer!  #speed:0.04
    
    What? My reaction is completley normal. #speaker:Dr. Green #portrait:ms_yellow_neutral #layout:right #audio:animalcrossinglow #object:false
